    ...
    return (
        <div className="bg-slate-50 font-sans text-slate-700">
            ...
            <Section
                className="bg-slate-50"
            >
                <FadeIn delay={0.2} className="mx-auto max-w-5xl px-6">
            ...
            <Section
                ...
                subtitle="提供サービス"
            >
                <FadeIn delay={0.2} className="mx-auto max-w-6xl space-y-24">
            ...
            <Section
                ...
                background="muted"
            >
                <FadeIn delay={0.2} className="mx-auto max-w-4xl bg-white rounded-[2.5rem] p-8 sm:p-16 shadow-sm border border-slate-100">
